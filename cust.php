...
<center><h2>CUSTOMER INFORMATION STORAGE</h2></center>
    <CENTER><u>Please fill in the following details with care</u></CENTER>
<br><br>
<form method="post">

Social Security Number: <input type="text" name="cid"required /><br/><br/>
First Name: <input type="text" name="c_fname"required /><br/><br/>
Last Name:  <input type="text" name="c_lname"/><br/><br/>
Address:   <input type="textarea" name="address" required/><br/><br/>
Email-id:  <input type="text" name="cemail_id"required/><br/><br/>
Phone Number: <input type="text" name="c_phno"required/><br/><br/>   
...
{
    if(!filter_var($_POST["cemail_id"],FILTER_VALIDATE_EMAIL)){
 ...
 $id="";$cfn="";$cln="";$cadd="";$cmail="";$cph="";
    ...
    $cln=$_POST['c_lname'];
    $cadd=$_POST['address'];
    $cmail=$_POST['cemail_id'];
    $cph=$_POST['c_phno'];
       
   //     echo $cph;
    
 $check=mysqli_query($link,"SELECT c_phno from customer where c_phno='$cph' ");
    $checkrows=mysqli_num_rows($check);

  if($checkrows>0) {
      $msg1="Customer already exists";
...
echo "<script type='text/javascript'>alert('$msg');</script>";
  ...
  <a href="index1.html" class="w3-button w3-light-grey"><i class="fa fa-check-circle w3-margin-right"></i>Done</a>
    ...
    <h1><center>CUSTOMER INFORMATION UPDATION</center></h1>
    <form method="post">
 Enter the cid for updating<input type="text" name="cnid" required/> 
     <br><br>
First Name: <input type="text" name="ncfname" required/><br><br>
Last Name:  <input type="text" name="nclname" /><br><br/>
Address:   <input type="textarea" name="naddress" required/><br><br>
Email-id:  <input type="text" name="ncemailid" required/><br><br>
Phone Number: <input type="text" name="ncphno" required/><br><br>
   ...
   <?php 
    ...
    if(isset($_POST['update'])){
        if(!filter_var($_POST["ncemailid"],FILTER_VALIDATE_EMAIL)){
          $erm="Invalid mail format";
          echo "<script type='text/javascript'>alert('$erm');</script>";
    }
    else{
        $cnid="";
        $ncfname="";$nclname="";$ncemailid="";$ncphno="";
        $nlocid=""; $naddress="";
     $cnid=$_POST['cnid'];
    ...
    $ncemailid=$_POST['ncemailid'];
    $ncphno=$_POST['ncphno'];
       
        
        $sql1="UPDATE customer set c_fname='$ncfname', c_lname='$nclname',c_phno='$ncphno',address='$naddress',cemail_id='$ncemailid'
         where cid='$cnid' ";
...
$msg="1 record updated";
  ...
  <a href="index1.html" class="w3-button w3-light-grey"><i class="fa fa-check-circle w3-margin-right"></i>Done</a>
    ...
    <h1><center>CUSTOMER INFORMATION DELETION</center></h1>
    <form method="post">
        Enter the cid for deleting<input type="text" name="dcid" required /> 
     <br><br>
 ...
 $sql2="DELETE FROM customer WHERE cid='$dcid'";
